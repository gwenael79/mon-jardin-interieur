...
import bouquetJardin from './bouquet_jardin.png'
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 0, padding: '18px 20px', borderRadius: 16, background: 'rgba(255,255,255,.02)', border: '1px solid rgba(255,255,255,.06)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              {[
                ...
                {
                  icon: <img src={bouquetJardin} alt="bouquet" style={{ width: 38, height: 38, objectFit: 'contain', mixBlendMode: 'screen' }} />,
                  color: 'rgba(150,212,133,.9)',
                  title: 'Le Jardin de soutien',
                  desc: "Dans cet espace, vous pouvez envoyer une intention positive à un autre jardinier sous la forme d'un bouquet de fleurs. Ce geste symbolique apporte du soutien, de la joie et rappelle que personne ne cultive son jardin seul.",
                },
                {
                  icon: <span style={{ fontSize: 28, lineHeight: 1 }}>❤️</span>,
