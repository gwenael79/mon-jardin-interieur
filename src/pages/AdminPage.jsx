...
.adm-badge{font-size:18px;letter-spacing:.1em;text-transform:uppercase;padding:4px 12px;border-radius:100px;background:rgba(210,80,80,0.12);border:1px solid rgba(210,80,80,0.3);color:#ffffff}
...
.adm-report-card{background:#3d4248;border:1px solid rgba(255,255,255,0.10);border-radius:12px;padding:16px 20px;display:flex;align-items:flex-start;gap:14px}
.adm-report-card.resolved{opacity:.4}
.adm-report-flag{font-size:18px;flex-shrink:0;margin-top:2px}
.adm-report-body{flex:1}
.adm-report-graine{font-size:18px;font-weight:400;color:#ffffff;margin-bottom:3px}
.adm-report-meta{font-size:18px;color:rgba(255,255,255,0.50);letter-spacing:.03em;margin-bottom:10px}
...
@media(max-width:700px){
  /* Topbar */
  .adm-topbar{padding:10px 12px;gap:6px;flex-wrap:wrap}
  .adm-logo{font-size:15px;flex:1}
  .adm-topbar > div:last-child{display:flex;gap:4px;align-items:center;flex-wrap:wrap}
  .adm-badge{font-size:11px!important;padding:3px 7px}
  ...
  .adm-td{padding:7px 10px;font-size:12px!important}

  /* Report cards */
  .adm-report-card{padding:10px 12px;gap:8px}
  .adm-report-graine{font-size:14px!important}
  .adm-report-actions{flex-wrap:wrap;gap:6px}
  .adm-report-actions .adm-btn{flex:1;text-align:center;padding:7px 8px;font-size:11px!important}
...
const VAR_LABELS = {
  ...
  '--ritual-modal-bg-start':{ label: 'Modal rituel — fond haut',  group: 'Zones rituels', usage: 'Couleur de début du dégradé du modal de rituel (haut)' },
  '--ritual-modal-bg-end':  { label: 'Modal rituel — fond bas',   group: 'Zones rituels', usage: 'Couleur de fin du dégradé du modal de rituel (bas)' },
  '--ritual-modal-text':    { label: 'Modal rituel — texte',      group: 'Zones rituels', usage: 'Couleur de tous les textes dans les modals de rituel' },
  '--ritual-item-bg':       { label: 'Modal rituel — item fond',  group: 'Zones rituels', usage: 'Fond des items de rituel non complétés' },
  '--ritual-item-border':   { label: 'Modal rituel — item bord',  group: 'Zones rituels', usage: 'Bordure des items de rituel non complétés' },
