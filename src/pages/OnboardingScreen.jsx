...
export const ONBOARDING_SLIDES = [
  ...
  },
  {
    ...
    bullets: [
      ...
      { label: 'Votre élan intérieur s\'étiole', desc: 'La motivation baisse, les plaisirs s\'effacent, on fait ce qu\'il faut sans vraiment y être.', example: '→ "Je fais les choses en automatique. Je ne sais plus ce que je veux."',
        descDesktop: 'Ce n\'est pas de la dépression, ce n\'est pas de la flemme. C\'est une batterie qui se vide. On continue à fonctionner, en mode économie d\'énergie. Les projets attendent. Les envies se taisent.' },
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      { icon:'👁', label: 'Pas visible', desc: 'Le bien-être intérieur ne se mesure pas dans un miroir.',
        descDesktop: 'On va chez le médecin pour une douleur physique. Mais un épuisement intérieur ? On le minimise. On se dit qu\'on exagère. Pourtant, ce qu\'on ne voit pas peut faire autant de dégâts, voire plus.' },
  ...
  },
  {
    ...
    bodyDesktop: 'Votre cerveau est une machine à habitudes. Quand vous répétez un geste au même moment, dans le même contexte, il crée un sillon neuronal, une véritable autoroute qui se renforce à chaque passage. Au bout de quelques jours, il anticipe, libère de la dopamine avant même que vous commenciez. C\'est le secret des rituels : ils ne demandent plus d\'effort, ils deviennent automatiques.',
    mechanisms: [
      ...
      {showPanel && !isMobile && (
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: 24,
            background: 'rgba(8,4,1,0.72)', backdropFilter: 'blur(20px)',
            boxShadow: '0 28px 70px rgba(0,0,0,0.50), inset 0 1px 0 rgba(255,255,255,0.06)',
...
export function OnboardingScreen({ userId, onComplete }) {
  ...
  if (phase === -2 || phase === -1) return (
    <>
      {/* Utilisateur de retour : VeilScreen → chemin directement, sans MP4 */}
      {introAlready ? (
        <VeilScreen onDone={() => setPhase('chemin')} />
      ) : (
        <>
