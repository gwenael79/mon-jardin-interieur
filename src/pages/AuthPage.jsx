...
export function AuthPage() {
  ...
  async function handleSignUp(e) {
    ...
    if (age < 16) { setError('Vous devez avoir au moins 16 ans pour vous inscrire.'); return }
    setError(null); setIsLoading(true)
    try {
      // Passer display_name et birthdate dans les metadata Supabase
      // Le trigger les récupère directement sans attendre la confirmation email
      ...
      // Si confirmation email désactivée : user est directement connecté
            ...
            <form onSubmit={view === 'login' ? handleSignIn : handleSignUp}>
              ...
              {view === 'register' && (
                <div className="auth-field">
                  ...
                  />
                  <div className="auth-hint">Utilisée uniquement pour personnaliser votre expérience</div>
                </div>
              )}
