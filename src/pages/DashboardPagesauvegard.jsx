...
/* ── LUMENS ─────────────────────────────────────────── */
@keyframes lumenBreathe {
  0%, 100% { opacity: 0.3; transform: scale(1); }
  50%       { opacity: 0.65; transform: scale(1.06); }
}
@keyframes lumenPulse {
  0%, 100% { box-shadow: 0 0 8px rgba(246,196,83,0.4), 0 0 20px rgba(246,196,83,0.15); }
  50%       { box-shadow: 0 0 16px rgba(246,196,83,0.7), 0 0 40px rgba(246,196,83,0.25); }
}
.lumen-orb {
  width: 18px; height: 18px; border-radius: 50%;
  background: radial-gradient(circle at 35% 35%, #FFF6D8, #F6C453, #C8942A);
  box-shadow: 0 0 8px rgba(246,196,83,0.5), 0 0 20px rgba(246,196,83,0.2);
  animation: lumenBreathe 4s ease-in-out infinite;
  flex-shrink: 0;
}
.lumen-halo-faible   { }
.lumen-halo-halo     { box-shadow: 0 0 18px rgba(246,196,83,0.25), 0 0 40px rgba(246,196,83,0.1) !important; }
.lumen-halo-aura     { box-shadow: 0 0 28px rgba(246,196,83,0.4),  0 0 60px rgba(246,196,83,0.15) !important; animation: lumenPulse 4s ease-in-out infinite !important; }
.lumen-halo-rayonnement { box-shadow: 0 0 40px rgba(246,196,83,0.6), 0 0 80px rgba(246,196,83,0.2) !important; animation: lumenPulse 3s ease-in-out infinite !important; }
.sb-lumen-bar {
...
.sb-lumen-label { font-size: 10px; color: rgba(246,196,83,0.6); letter-spacing: .06em; flex:1 }
.sb-lumen-count { font-size: 12px; font-family: 'Cormorant Garamond', serif; color: #F6C453; }
.sb-lumen-level { font-size: 9px; color: rgba(246,196,83,0.45); letter-spacing: .05em; text-transform: uppercase; }
...
.lumen-badge.loss {
  background: rgba(210,110,110,0.08);
  border: 1px solid rgba(210,110,110,0.22);
  color: rgba(220,140,140,0.85);
}
.lumen-badge-dot {
  width: 6px; height: 6px; border-radius: 50%;
  background: radial-gradient(circle at 35% 35%, #FFF6D8, #F6C453);
  box-shadow: 0 0 4px rgba(246,196,83,0.5);
  flex-shrink: 0;
}
/* ── CERCLES ── */
...
───────────────────────────────────────── */
let _svgN = 0
function PlantSVG({ health = 72, gardenSettings = DEFAULT_GARDEN_SETTINGS, lumensLevel = 'faible' }) {
      ...
      <div className="mj-left">
        ...
        <div className="plant-hero ph-2col">
          <div className="ph-col-flower">
            <PlantSVG health={todayPlant?.health ?? 50} gardenSettings={gardenSettings} lumensLevel={lumens?.level ?? 'faible'} />
          </div>
        ...
        <JournalComposer userId={userId} plantId={todayPlant?.id} onSaved={entry => { awardLumens?.(1, 'questionnaire_daily', { date: new Date().toISOString().split('T')[0] }) }} />
        {entries.map(e => (
